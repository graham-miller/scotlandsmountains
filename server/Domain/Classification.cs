    ...
    public class Classification : HasId
    {
        ...
        public static IList<Classification> Build()
        {
            return new List<Classification>
            {
                ...
                new Classification {DobihCode = "5", Name = "Dodd"},
                ...
                new Classification {DobihCode = "Dew", Name = "Dewey"},
                new Classification {DobihCode = "DDew", Name = "Donald Dewey"},
                new Classification {DobihCode = "HF", Name = "Highland Five"},
                ...
                new Classification {DobihCode = "s5", Name = "Sub Dodd"},
                new Classification {DobihCode = "sMDew", Name = "Sub Myrddyn Dewey"},
                ...
                new Classification {DobihCode = "MDew", Name = "Myrddyn Dewey"},
